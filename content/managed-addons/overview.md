...
| Addon | What It Does |
|-------|-------------|
| Harbor | Private container image and Helm chart registry. Push your images and charts here; ArgoCD deploys from here. Scoped to your cluster and tenants. |
...
| [RHACS](./rhacs/overview.md) *(optional)* | Red Hat Advanced Cluster Security. Runtime threat detection, vulnerability scanning, image policy enforcement, and compliance reporting. Available on request — not included in the base subscription. |
