...
- [Automate dependency merges](./how-to-guides/automerge.md) — configure Renovate to approve and merge updates automatically when CI passes
- [Run Renovate locally](./how-to-guides/run-locally.md) — validate configuration or troubleshoot without pushing to your repository
