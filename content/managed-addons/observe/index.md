...
Signals (metrics, logs, traces) are emitted by your application via the OpenTelemetry SDK over OTLP. Alerts, dashboards, and uptime monitors are declared through your application's `values.yaml` for the [Stakater Application Helm Chart](../helm-leader-chart/index.md) and shipped via GitOps.
