...
1. Find the Image registry URL the Harbor registry URL (find it in Forecastle) or Navigate to the cluster Forecastle, search `nexus` using the search bar on top menu and copy the nexus URL.
